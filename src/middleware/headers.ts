...
module.exports = function (middleware) {
    middleware.addHeaders = helpers_1.default.try((req, res, next) => {
        const headers = {
        ...
        if (meta_1.default.config['permissions-policy']) {
            headers['Permissions-Policy'] = meta_1.default.config['permissions-policy'];
        }
        ...
        if (process.env.NODE_ENV === 'development') {
            headers['X-Upstream-Hostname'] = os_1.default.hostname();
        }
    ...
    middleware.autoLocale = helpers_1.default.try((req, res, next) => __awaiter(this, void 0, void 0, function* () {
        yield plugins_1.default.hooks.fire('filter:middleware.autoLocale', {
            req: req,
            res: res,
        });
        if (req.query.lang) {
    ...
    function listCodes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const codes = yield languages_1.default.listCodes();
                return lodash_1.default.uniq([defaultLang, ...codes]);
            }
            catch (err) {
